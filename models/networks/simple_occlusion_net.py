...
class SimpleOcclusionNet(nn.Module):
    """"
    A simple occlusion prediction network take the input as concatenated image pairs and predict the soft occlusion map
    """
    def __init__(self, in_channels=3*2):
        ...
        self.up7 = Upsample(64+in_channels, 1, 3, activation=False) # skip-connected with output from input
        self.sigmoid = nn.Sigmoid() # restrict the occlusion map value between [0, 1]
